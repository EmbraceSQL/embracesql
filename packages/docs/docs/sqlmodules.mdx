...
```sql title="./migrations/001.sql" file="../../engine/tests/configs/sqlmodules-transactions/migrations/001.sql"
```

```sql title="./migrations/002.sql" file="../../engine/tests/configs/sqlmodules-transactions/migrations/002.sql"
```
...
```typescript title="./add.sql.before.js" file="../../engine/tests/configs/sqlmodules/default/add.sql.before.ts"
```

And after the query -- let's read back the rows. 
This pretty handy as a general trick by the way to read back a lookup table.

```typescript title="./add.sql.before.js" file="../../engine/tests/configs/sqlmodules/default/add.sql.after.ts"
```
...
```typescript title="./add.sql.before.js" file="../../engine/tests/configs/sqlmodules-transactions/default/add.sql.before.ts"
```

```typescript title="./add.sql.before.js" file="../../engine/tests/configs/sqlmodules-transactions/default/add.sql.after.ts"
```
...
```sql title="./migrations/003.sql" file="../../engine/tests/configs/sqlmodules-transactions/migrations/003.sql"
```

```sql title="./migrations/004.sql" file="../../engine/tests/configs/sqlmodules-transactions/migrations/004.sql"
```

```sql title="./migrations/005.sql" file="../../engine/tests/configs/sqlmodules-transactions/migrations/005.sql"
```
